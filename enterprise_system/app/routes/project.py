...
from app.models import db, User, Project, ProjectMember
...
def get_current_user():
    ...
    return jsonify({
        ...
        'user': {
            ...
            'projects': _get_user_projects(user_id)  # 通过ProjectMember查询项目
        }
    })
